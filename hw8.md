# 🧠 Работа с типами из JavaScript библиотек (Declaration files)

## 🎯 Цель

Научиться подключать и использовать типы из сторонних JavaScript библиотек в проекте на TypeScript, создавать собственные declaration files (`.d.ts`) для не типизированных библиотек и интегрировать их с вашим кодом.

---

## 📦 Задание: Подключение и создание declaration files в проекте budget-tracker-cli

В этом задании вы расширите ваш проект budget-tracker-cli, используя типы из сторонних JavaScript библиотек, а также создадите собственные декларации типов для не типизированных модулей.
...
- Выберите одну из популярных небольших JavaScript библиотек, которые часто применяются для работы с датами, форматированием или генерацией уникальных идентификаторов. Например:
